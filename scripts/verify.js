...
const IDS = ['page-pos', 'order-panel', 'op-items', 'op-tot', 'pcats', 'pin-modal',
  ...
  'scan-modal', 'op-lealtad', 'tarjeta-view', 'lealtad-tabla', 'lealtad-segmentos', 'lp-msg', 'corte-tc-propina', 'corte-tc-desglose', 'bt-pos-chip', 'cp-1', 'nom-propinas', 'inv-filtro-res', 'btn-reg-asist', 'cfg-rfc'];
IDS.forEach(id => {
