...
const FNS = ['cobrar', 'renderOrder', 'renderPOS', 'realizarCorte', 'calcDia',
  ...
  'abrirScanLealtad', 'altaLealtad', 'registrarSelloLealtad', 'renderTarjetaPublica', 'renderLealtadPanel', 'canjearPremio', 'renderCampana', 'setLtSegmento', 'abrirCfgLealtad'];
FNS.forEach(fn => {
...
const IDS = ['page-pos', 'order-panel', 'op-items', 'op-tot', 'pcats', 'pin-modal',
  ...
  'scan-modal', 'op-lealtad', 'tarjeta-view', 'lealtad-tabla', 'lealtad-segmentos', 'lp-msg'];
IDS.forEach(id => {
