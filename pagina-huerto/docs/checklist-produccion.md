...
- [ ] Actualizar `SITE.url` en `lib/site.ts` al dominio real
...
- [ ] Dominio conectado y HTTPS verificado
...
- [ ] Google Business Profile del kiosco (recomendado) enlazando al sitio
